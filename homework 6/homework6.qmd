...
#This function is modified by chatgpt
# Define the C++ code
cpp_code <- "
#include <Rcpp.h>
#include <cmath>
...
library(methods)
library(parallel)
source("wald_ci.R") #the wald_ci is imported from ps5 solution
...
#using helper function to handel the different compute method is inspired by gemini
...
makeBootstrapCI <- function(func, data, reps = 100, level = 0.95, compute = "serial") {
  
  original_est <- func(data)
  
  boot_se <- compute_selection(func, data, reps, compute)
...
# additional function rebootstrap
...
#gemini taught me to automatically fit models to separate countries
...
### b.   
```{r}
# Parallel processing (this is inspired by problem 2)
