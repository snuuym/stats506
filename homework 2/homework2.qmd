...
The link to my github repository: [homework 2](https://github.com/snuuym/stats506/tree/main/homework%202)
...
```{r}
#' random_walk3: start at 0, generate walks for n times and return the final position of walk, using the special apply functiion: replicate
#' @param n The number of steps
#'
#' @return The final position of the walk

#chatgpt told me to use replicate as a simplified special apply method for this question
...
```{r}
library(dplyr)
removed_cols = c("brand","superbowl_ads_dot_com_url", "youtube_url", "id", "etag", "published_at", "title","description", "thumbnail", "channel_title")
removed_youtube <- youtube %>% select(-all_of(removed_cols))
dim(removed_youtube)
```

*Answer:* There are 247 rows and 15 columns after de-identifying it.
